...
localparam [127:0] PT_A  = 128'h00112233445566778899aabbccddeeff;
localparam [127:0] CT_A  = 128'h69c4e0d86a7b0430d8cdb78070b4c55a;

localparam [127:0] KEY_B = 128'h00000000000000000000000000000000;
localparam [127:0] PT_B  = 128'h00000000000000000000000000000000;
localparam [127:0] CT_B  = 128'h66e94bd4ef8a2c3b884cfa59ca342b2e;
...
initial begin
    ...
    submit_block(PT_A, KEY_A, CT_A);
    submit_block(PT_B, KEY_B, CT_B);
    submit_block(PT_A, KEY_A, CT_A);
    submit_block(PT_B, KEY_B, CT_B);
    submit_block(PT_A, KEY_A, CT_A);
    submit_block(PT_B, KEY_B, CT_B);
